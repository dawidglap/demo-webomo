      ...
      <div className="container lg:max-w-[1120px]">
        <div className="-mx-4 flex flex-wrap items-center justify-between">
          ...
          <div className="w-full px-4 lg:w-1/2">
            <motion.div
              ref={smartphonesRef}
              className="relative z-10 mx-auto mb-14 w-full max-w-[470px]  rounded-md bg-gradient-to-r from-indigo-200 to-purple-300  p-6 pb-10 shadow-2xl dark:from-sky-900 lg:mx-0 lg:mb-0"
              initial="hidden"
          ...
          <div className="w-full px-4 lg:w-1/2">
            ...
            >
              ...
              <p className="mb-[20px] text-base leading-relaxed text-slate-600 dark:text-slate-400">
